...
async function get_back_chat(data, setTheArray, messages){
...
function update_back_chat(id, setTheArray, messages, centrifuge){
...
function update_common_chat(setTheArray, messages, sse){
    let date;
    let date_send;
...
export function Display(props) {
    ...
    useEffect(() => {
        ...
        .then(() =>{if(props.id == "tt-front"){
                        ...
                        update_common_chat(setTheArray, messages, sse);
                    }else{
                        update_back_chat(props.id, setTheArray, messages, centrifuge);
                    }
            })
